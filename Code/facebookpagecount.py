...
if not USER_ACCESS_TOKEN or not PAGE_ID:
    raise ValueError("Please ensure USER_ACCESS_TOKEN and PAGE_ID are set in the .env file.")

# Graph API URL with the fields you want to retrieve
url = f'https://graph.facebook.com/v17.0/{PAGE_ID}?fields=id,name,about,fan_count&access_token={USER_ACCESS_TOKEN}'
